...
export const de: EnDict = {
  ...
  "dashboard.live.connecting": "verbinde…",
  "dashboard.live.fallback": "abfrage",
  "dashboard.live.title": "Live-Status: WebSocket sendet alle 5 s neue Metriken; bei Trennung 30-s-Polling.",

  // ── User management (#123) ────────────────────────────────────
  "nav.users": "Benutzer",
  "users.kicker": "Panel-Zugang",
  "users.title": "Benutzerverwaltung",
  "users.hint": "Nur Admin. Analysten/Viewer hinzufügen, Rollen ändern, Konten deaktivieren. Deaktivierte Zeilen bleiben im Audit-Log via FK.",
  "users.forbidden": "Diese Seite ist nur für Admins.",
  "users.error_load": "Benutzer konnten nicht geladen werden.",
  "users.error_generic": "Änderung konnte nicht gespeichert werden.",
  "users.empty": "Keine Benutzer im System.",
  "users.form.title": "Benutzer hinzufügen",
  "users.form.email": "EMAIL",
  "users.form.password": "PASSWORT (≥8 Zeichen)",
  "users.form.submit": "Erstellen",
  "users.col.email": "Email",
  "users.col.role": "Rolle",
  "users.col.status": "Status",
  "users.col.last_login": "Letzter Login",
  "users.col.actions": "Aktionen",
  "users.status.active": "aktiv",
  "users.status.disabled": "deaktiviert",
  "users.actions.disable": "Deaktivieren",
  "users.actions.enable": "Aktivieren",
  "users.actions.delete": "Löschen",
  "users.actions.delete_confirm": "Benutzer {email} löschen? Er wird als inaktiv markiert, bleibt aber im Audit-Log.",
};
